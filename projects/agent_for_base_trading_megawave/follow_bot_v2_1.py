...
from kyberswap_buybot_1 import kyberswap_swap
...
class virtual_follow_bot_V2:
    def __init__(self, 
        ...
        # 外盘跟单参数
        self.waipan_buy_rate = 0.4*10**-12
        self.waipan_sell_rate = 0.33
        self.neipan_buy_rate = 1
        self.neipan_sell_rate = 1
        self.waipan_buy_max = 1000
        self.neipan_buy_max = 700
        self.TIME_LIMIT = 30
